...
#pragma message("ecs_defs.h ENCONTRADO")
#include "../game/ecs_defs.h"
#else
#pragma message("ecs_defs.h NO ENCONTRADO - usando defaults")
...
constexpr sysId_t maxSystemId = sys::sysList::size;
...
template<typename T>
constexpr sysId_t sysId = mpl::IndexOf<T, sys::sysList>();
